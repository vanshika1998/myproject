...
public class contact extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String u = request.getParameter("fullname");
            String ea = request.getParameter("number");
            String w = request.getParameter("Email");
            String p = request.getParameter("subject");
            String y = request.getParameter("message");
        try (PrintWriter out = response.getWriter()) {
            ...
            stmt.setString(5,y);
            stmt.executeUpdate();
            RequestDispatcher rd = request.getRequestDispatcher("responses.html");
